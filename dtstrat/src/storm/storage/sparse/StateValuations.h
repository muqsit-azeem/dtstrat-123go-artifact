   ...
   public:
    ...
    class StateValuation {
       public:
        ...
        friend std::ostream& operator<<(std::ostream& os, const StateValuation& valuation);
    ...
    StateValuation getStateValuation(uint const& currentStateId) const;
...
class StateValuationsBuilder {
   public:
    ...
    StateValuations::StateValuation getStateValuation(uint const& currentStateId) const;
