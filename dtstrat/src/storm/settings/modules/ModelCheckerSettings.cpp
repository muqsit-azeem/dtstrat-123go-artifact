...
const std::string ModelCheckerSettings::useDtStrat = "dtstrat";
...
ModelCheckerSettings::ModelCheckerSettings() : ModuleSettings(moduleName) {
    ...
    this->addOption(storm::settings::OptionBuilder(moduleName, ltl2daToolOptionName, false,
                        ...
                        .addArgument(storm::settings::ArgumentBuilder::createStringArgument(
                                         ...
                                         .build())
                        .build());
    this->addOption(storm::settings::OptionBuilder(moduleName, useDtStrat, false, "If set, use DTStrat.")
                        .setIsAdvanced()
                        .build());
}
...
bool ModelCheckerSettings::useDTStrat() const {
    return this->getOption(useDtStrat).getHasOptionBeenSet();
}
