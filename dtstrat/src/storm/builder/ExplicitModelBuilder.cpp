...
void ExplicitModelBuilder<ValueType, RewardModelType, StateType>::buildMatrices(
    ...
    while (!statesToExplore.empty()) {
        ...
        if (behavior.empty()) {
            //STORM_PRINT("No choice given, introduce self loop for "<<currentRow << "\n");
            if (stateAndChoiceInformationBuilder.isBuildChoiceLabels()) {
                stateAndChoiceInformationBuilder.addChoiceLabel("NEW-SELF-LOOP", currentRow);
            }
            ...
            for (auto const& choice : behavior) {
                ...
                /*if (stateAndChoiceInformationBuilder.isBuildChoiceLabels() && !choice.hasLabels()) {
                    STORM_PRINT("State "<<currentState<< " action " << currentRow <<" has no label.\n");
                }*/
                if (stateAndChoiceInformationBuilder.isBuildChoiceLabels() && choice.hasLabels()) {
